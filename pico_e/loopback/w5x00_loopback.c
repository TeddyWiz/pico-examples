...
int main()
{
    ...
    IP4_ADDR(&g_ip, 192, 168, 15, 200);
    IP4_ADDR(&g_mask, 255, 255, 255, 0);
    IP4_ADDR(&g_gateway, 192, 168, 15, 1);
    ...
    printf("WIZnet 5xxx LWIP Program Start!\r\n");
    printf("ip address: %d.%d.%d.%d port : %d\r\n", ip4_addr1_16(&g_ip), ip4_addr2_16(&g_ip), ip4_addr3_16(&g_ip), ip4_addr4_16(&g_ip), PORT_LWIPERF);
    //4_addr_debug_print(debug, g_ip);
